    ...
    <div class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <c:if test = "${empty loginedUser.userName}">
                <div class="col">
                    <button type="button" id="bSignIn" class="btn btn-outline-info btn-lg"><a href="login">Se connecter</a></button>
                </div>
                </c:if>
                <c:if test = "${not empty loginedUser.userName}">
                <div class="col">
                    <button type="button" id="bSignOut" class="btn btn-outline-info btn-lg"><a href="logout">Se déconnecter</a></button>
                </div>
                </c:if>
            </div>
        </div>
